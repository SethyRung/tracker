...
// Share weights are integer basis points in [0, 10000] (2500 = 25%). 10000 = 100%.

describe("weight", () => {
  describe("bpsToPercent", () => {
    it("converts 10000 to 100", () => {
      expect(bpsToPercent(10000)).toBe(100);
    });

    it("converts 2500 to 25", () => {
  ...
  describe("equalSplitBps", () => {
    ...
    it("returns 3333 for 3 attendees (floored)", () => {
  ...
  describe("splitRemainderBps", () => {
    ...
    it("returns the missing basis points for 7 attendees", () => {
      // floor(10000 / 7) = 1428; 10000 - 1428 * 7 = 4
